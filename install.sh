...
# 3. add config file
wget -O config.json https://raw.githubusercontent.com/koayeminzt-hash/idx/refs/heads/main/config.json
sed -i 's/$PORT/'$PORT'/g' config.json
sed -i 's/$UUID/'$UUID'/g' config.json

# 4. create startup.sh
wget https://github.com/koayeminzt-hash/idx/raw/refs/heads/main/startup.sh
